...
//import com.example.myto_dolist.databinding.ActivityWorkBinding
...
//            taskDao.fetchWorkIncompleteTasks().collect{
...
//
//        lifecycleScope.launch {
//            taskDao.fetchWorkCompleteTasks().collect{
//                val tasklist = ArrayList(it)
...
//
//        lifecycleScope.launch {
//            taskDao.searchDatabaseForWorkIncomplete(searchQuery).collect{
//                val tasklist = ArrayList(it)
//                setupListofDataIntoRecyclerView(tasklist, taskDao)
//
//            }
//        }
//        lifecycleScope.launch {
//            taskDao.searchDatabaseForWorkComplete(searchQuery).collect{
//                val tasklist = ArrayList(it)
//                setupListofDataIntoCompletedItemsRecyclerView(tasklist, taskDao)
//
//            }
...
//                lifecycleScope.launch {
//                    taskDao.fetchWorkSortedTasks().collect{
//                        val tasklist = ArrayList(it)
//                        setupListofDataIntoRecyclerView(tasklist, taskDao)
//
//                    }
//                }
//                lifecycleScope.launch {
//                    taskDao.fetchWorkSortedCompletedTasks().collect{
//                        val tasklist = ArrayList(it)
//                        setupListofDataIntoCompletedItemsRecyclerView(tasklist, taskDao)
//
//                    }
...
//                //write code here to sort items in recyclerview
//                lifecycleScope.launch {
//                    taskDao.fetchWorkSortedTasksByTime().collect{
//                        val tasklist = ArrayList(it)
//                        setupListofDataIntoRecyclerView(tasklist, taskDao)
//
//                    }
//                }
//                lifecycleScope.launch {
//                    taskDao.fetchWorkSortedCompletedTasksByTime().collect{
//                        val tasklist = ArrayList(it)
//                        setupListofDataIntoCompletedItemsRecyclerView(tasklist, taskDao)
//
//                    }
...
//                id: Long
//            ) {
//                Toast.makeText(this@WorkActivity, "${categories[position]}", Toast.LENGTH_LONG).show()
